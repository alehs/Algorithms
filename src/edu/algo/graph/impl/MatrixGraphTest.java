...
public class MatrixGraphTest {
    ...
    public void testGetIncomingNodes() {
         ...
         */
        Graph graph = new MatrixGraph(new int[][] {{0,1,0,0},{1,0,2,3},{0,2,0,0},{0,3,0,0}});
        Assert.assertArrayEquals(new Integer[] {2}, graph.getIncomingNodes(1).toArray());
        Assert.assertArrayEquals(new Integer[] {1,3,4}, graph.getIncomingNodes(2).toArray());
        Assert.assertArrayEquals(new Integer[] {2}, graph.getIncomingNodes(3).toArray());
        Assert.assertArrayEquals(new Integer[] {2}, graph.getIncomingNodes(4).toArray());
    }
}
